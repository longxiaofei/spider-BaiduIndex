...
class BaiduIndex:
    ...
    def __init__(self, keywords: list, start_date: str, end_date: str, kind="news", area=0):
        ...
        while 1:
            try:
                ...
                for encrypt_data in encrypt_datas:
                    encrypt_data['data'] = self._decrypt_func(key, encrypt_data['data'])
